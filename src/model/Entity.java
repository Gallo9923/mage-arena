...
public abstract class Entity implements Update, Serializable, Cloneable {
	 ...
	 */
	public Entity(AnimatedImage sprite, double posX, double posY, double width, double height, double offsetX,
	...
	/**
	 * Determines if the hitbox of the entity intersects with another hitbox of
	 * other entity
	 * 
	 ...
	 * 
	 * @return True if the hitbox of the entity intersects any of the edges of the
	 *         window
	 */
	 ...
	 * 
	 * @return True if the hitbox of the entity intersects the left edge of the
	 *         window
	 */
	 ...
	 * 
	 * @return True if the hitbox of the entity intersects the right edge of the
	 *         window
	 */
	 ...
	 * 
	 * @return True if the hitbox of the entity intersects the top edge of the
	 *         window
	 */
	 ...
	 * 
	 * @return True if the hitbox of the entity intersects the bottom edge of the
	 *         window
	 */
