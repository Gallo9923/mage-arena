...
public class AnimatedImage implements Serializable{
    ...
    /**
     * Constructs an AnimatedImage in charge of displaying the movement
     * animations of each entity
     * @param String[] frames Path of each image for the animation
    ...
    /**
     * Returns the current image of the animations
     * given a certain duration, which cycles between all
     * frames
